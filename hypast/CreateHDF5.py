...
class CreateHDF5():
    ...
    def create_hdf5(self, xlist, ylist, depth, turn, hdf5_path): 
        ...
        with h5py.File(hdf5_path, 'w') as hdf5_file:
            hdf5_file.create_dataset("data", (130,130,depth),maxshape = (130,130,None) , dtype='uint16',chunks=True)
            hdf5_file.create_dataset("label", (130,130,depth),maxshape = (130,130, None),dtype='float16',chunks=True)
    ...
    def create_links(self):
        ...
        xtrain, xval, ytrain, yval = train_test_split(self.list_data, self.list_label, test_size=0.15, random_state=4321)
